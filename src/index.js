...
const userInfoLogic = new UserInfo(
  ".profile__title",
  ".profile__subtitle",
  ".profile__avatar"
);
...
const profilePopupLogic = new PopupWithForm(
  ".popup_type_profile",
  (evt, values) => {
...
const cardPopupLogic = new PopupWithForm(
  ".popup_type_add-card",
  (evt, values) => {
    const submitBtn = evt.submitter;
    submitBtn.textContent = "Сохранение...";
...
const avatarPopupLogic = new PopupWithForm(
...
addCardButton.addEventListener(
  "click",
  cardPopupLogic.open.bind(cardPopupLogic)
);
profileAvatar.addEventListener(
  "click",
  avatarPopupLogic.open.bind(avatarPopupLogic)
);
